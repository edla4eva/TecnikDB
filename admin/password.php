...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css">
  ...
  <?php 
          $current_page="{assword";
          $current_page_link="password.php";
          include "sections/nav.php";
      ?>
  <!--   <form method="post" action="<?php //echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  post to sme page-->
    <?php if (isset($msg)) echo $msg; ?>
  <form class= "form-signin" method="post" action="change-password.php">  <!-- form action="svr/login.php" or button onClick="pasuser(this.form)"  -->
