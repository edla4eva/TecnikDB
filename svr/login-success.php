...
<html lang="en">
  ...
  <div class="header"><h1 class="text-center">Success!</h1> <hr></div>
    ...
    <h3 class="text-center">Signin was successfully</h3>
    <p class="text-center">Congratulations! You now have unlimited access to this Web application. </br> 
    Click <a href="../fulltree.php">here</a> to vew family tree or go back to <a href="../home.php">home</a></p>
  </div>
